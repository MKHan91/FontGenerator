...
parser.add_argument('--model_dir',      dest='model_dir',       type=str,            default=r'/home/dev/fontpython/experiments/checkpoint/experiment_7_batch_16',
...
parser.add_argument('--save_dir',                               type=str,            default=r'/home/dev/FONT/experiment_7_batch_16/inferred_result',
...
parser.add_argument('--progress_file',  dest='progress_file',   type=str,            default=r'/home/dev/fontpython/experiments/logs/experiment_7_batch_16/progress', 
